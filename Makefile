...
help:
	@echo ""
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo "  Mad Perfume Makefile — Available Commands"
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo ""
	@echo "  Local Dev:"
	...
	@echo "    make rollback TAG=<backend-sha> [FRONTEND_TAG=<frontend-sha>]  Rollback images"
	@echo ""
	@echo "  Monitoring:"
...
rollback:
	bash deployment/scripts/rollback.sh $(TAG) $(FRONTEND_TAG)
