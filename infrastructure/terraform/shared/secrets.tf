...
#     --name "madperfume/production/grafana-password" \
#     --secret-string "your-strong-password-here" \
#     --region us-east-1 \
#     --tags Key=Environment,Value=production Key=Project,Value=madperfume
#
# Or rotate via:
#   aws secretsmanager update-secret \
#     --secret-id "madperfume/production/grafana-password" \
